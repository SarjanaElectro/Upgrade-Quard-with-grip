...
/* -----------------------------------------------------------------------------
  - Project: Upgrade Quard Robot with Gripper
  - Youtube:  Sarjana Electro
  - Date:  2021/07/26
  - modified by Sarjana Electro From Indonesia
  - add remote control by HC-05 bluetooth module
...
#define eye A4
#define M1_in1 A0  //head
#define M1_in2 A1  //head
#define M2_in1 A2  //grip
#define M2_in2 A3  //grip
...
void setup()
{
  ...
  // w 2 x: back x step
  // w 3 x: left turn x step
  // w 4 x: right turn x step
